  ...
  return (
    ...
    >
      <div className="p-4 md:p-8">
        <div className="p-4 md:p-8" >
          <h1 className="flex items-center gap-2 md:gap-4 align-middle text-md sm:text-md md:text-4xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-600 pb-2 leading-10">
            Welcome to Dynasty Wallet
            <Image src='/banana.png' boxSize={{ base: "20px", md: "40px" }} />
          </h1>
          <p className="text-sm md:text-2xl bg-clip-text text-transparent bg-gradient-to-r from-gray-700 to-black">Your premier Web3 wallet focused on the Binance Smart Chain (BSC). Our goal is to provide you with a secure, reliable, and user-friendly tool for managing your digital currencies, making the world of blockchain accessible no matter where you are.</p>
          ...
          <p className="text-sm md:text-2xl bg-clip-text text-transparent bg-gradient-to-r from-gray-700 to-black mt-4">Join Dynasty Wallet to embark on your blockchain journey and explore endless possibilities.</p>
        </div>
      </div>
    </Transition>
  );
