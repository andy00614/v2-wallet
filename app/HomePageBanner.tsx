...
const HomePageBanner = () => {
  return (
    ...
    >
      <div className="p-8">
        <div className="p-8" >
          <h1 className="text-5xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-600 pb-2 leading-10">Welcome to Dynasty Wallet</h1>
