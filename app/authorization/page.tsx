        ...
        <Box p="5" borderRadius="md" shadow="md" bg="white">
          {
            isLogin ? <>
              ...
              <Text mb="5">
                <b className='text-red-500 font-bold'>{gameName}</b> is requesting access to your Wallet information. If you agree to share your information with Game A, please click "Authorize". If you do not want to share your information, please click "Reject".
              </Text>
              <Flex direction="row">
